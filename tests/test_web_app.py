...
class WebUiStaticTests(unittest.TestCase):
    ...
    def test_daily_briefs_mode_ui_is_present(self) -> None:
        ...
        self.assertIn("Historial", template)
        daily_briefs_template = template.split('id="daily-briefs"', maxsplit=1)[1].split('id="mobile-more"', maxsplit=1)[0]
        self.assertNotIn("Briefs diarios anteriores", daily_briefs_template)
        ...
        self.assertIn('class="brief-archive-panel"', template)
        self.assertIn('id="brief-archive-count"', template)
        self.assertIn("dailyBriefArchiveCount.textContent", script)
        self.assertIn("function briefArchiveTitle", script)
        self.assertIn("function formatArchiveDate", script)
        self.assertIn("function archiveMonthKey", script)
        self.assertIn("function formatArchiveMonth", script)
        self.assertIn("brief-archive-month", script)
        self.assertIn("brief-archive-button", script)
        self.assertIn('id="brief-mobile-history"', template)
        self.assertIn("function renderBriefMobileHistory", script)
        self.assertIn("data-brief-mobile-today", script)
        self.assertIn("data-brief-mobile-index", script)
        self.assertIn("data-brief-mobile-previous-days", script)
        self.assertIn('"mobile.previousDays": "Días anteriores"', script)
        self.assertIn('"mobile.previousDays": "Previous Days"', script)
        self.assertIn("function setBriefMobileHistoryExpanded", script)
        self.assertIn('dailyBriefs?.setAttribute("data-mobile-history-expanded", String(expanded))', script)
        self.assertIn("dailyBriefsList.dataset.mobileExpanded = String(expanded)", script)
        self.assertIn("dailyBriefArchiveCount.dataset.previousDaysCount", script)
        self.assertIn("data-brief-archive-month-count", script)
        self.assertIn("brief-archive-mobile-quick", script)
        self.assertIn('data-mobile-previous-count="${mobilePreviousCount}"', script)
        self.assertIn("setBriefMobileHistoryExpanded(false)", script)
        self.assertIn("setBriefMobileHistoryExpanded(true)", script)
        self.assertIn("data-daily-brief-today", script)
        self.assertIn("<strong>${escapeHtml(briefArchiveTitle(todayData))}</strong>", script)
        self.assertNotIn('"brief.todayAction"', script)
        self.assertIn("data-brief-index", script)
        self.assertIn("currentArchiveMonthKey", script)
        self.assertIn("brief-archive-month-button", script)
        self.assertIn("brief-archive-month-arrow", script)
        self.assertIn('aria-expanded="${expanded}"', script)
        self.assertIn("data-current-brief-static", script)
        self.assertIn(".brief-workspace", styles)
        self.assertIn(".brief-archive-panel", styles)
        self.assertIn(".brief-archive-month", styles)
        self.assertIn(".brief-archive-month-button", styles)
        self.assertIn(".brief-archive-month-arrow", styles)
        self.assertIn(".brief-archive-button", styles)
        self.assertIn(".brief-mobile-history", styles)
        self.assertIn('.daily-briefs[data-mobile-history-expanded="false"] .brief-archive-panel', styles)
        self.assertIn('.daily-briefs[data-mobile-history-expanded="true"] .brief-reader', styles)
        self.assertIn('.daily-brief-list[data-mobile-expanded="false"] .brief-archive-full', styles)
        self.assertIn('.daily-brief-list[data-mobile-expanded="true"] .brief-archive-mobile-quick', styles)
        self.assertIn('.daily-brief-list[data-mobile-expanded="true"] .brief-archive-month[data-mobile-previous-count="0"]', styles)
        self.assertIn(".daily-brief-card.current-brief-card:hover", styles)
        self.assertIn("grid-template-columns: minmax(0, 1fr) minmax(210px, 260px)", styles)
        ...
        self.assertIn("brief-loading-card", script)
        self.assertIn("brief-loading-line", script)
        self.assertIn('if (briefMobileHistory) briefMobileHistory.innerHTML = "";', script)
        self.assertIn("setBriefMobileHistoryExpanded(false)", script)
        self.assertIn(".brief-loading-card", styles)
        self.assertIn(".brief-loading-line", styles)
        self.assertIn(".brief-loading-head .skeleton-stack", styles)
        self.assertIn("flex: 1 1 auto", styles)
        self.assertIn(".brief-loading-orb", styles)
        self.assertIn(".brief-loading-dot", styles)
        self.assertIn("animation: shimmer 1300ms ease-in-out infinite", styles)
        self.assertNotIn(".daily-brief-skeleton", styles)
        self.assertNotIn("daily-brief-skeleton", script)
        ...
        self.assertIn('const meta = `${escapeHtml(data.n_noticias)} ${i18n("brief.articles")}`;', script)
        self.assertNotIn('${escapeHtml(data.modelo)}', script)
        self.assertNotIn("data-current-brief-toggle", script)
        self.assertNotIn("function bindCurrentBriefToggle", script)
        self.assertNotIn("function toggleDailyBrief", script)
        self.assertNotIn("daily-brief-chevron", script)
        self.assertNotIn("collapsible: true", script)
        ...
        self.assertNotIn(".daily-brief-chevron", styles)
        ...
        self.assertIn("function briefText", script)
        self.assertIn("${briefText(item.summary)}", script)
        self.assertIn("${briefText(json.trend_reading)}", script)
        self.assertNotIn('expandableText(item.summary, "brief-text"', script)
        self.assertNotIn('expandableText(json.trend_reading, "brief-text"', script)
        self.assertIn("function textPreview", script)
        self.assertIn('return expanded ? "Mostrar menos" : "Mostrar más"', script)
        self.assertIn('return expanded ? "Show less" : "Show more"', script)
        ...
        self.assertIn('expandableText(cleanSummary, "article-summary", heading.textContent || "", textPreview(cleanSummary, 240))', script)
    ...
    def test_sidebar_has_collapsible_responsive_state(self) -> None:
        ...
        self.assertIn("@media (min-width: 901px)", styles)
        self.assertIn(".sidebar {\n    padding: 16px 16px;", styles)
        self.assertIn(".preference-nav-button,\n  .preferences-section .sidebar-theme-toggle {\n    min-height: 50px;", styles)
    ...
    def test_mobile_shell_navigation_and_drawer_are_present(self) -> None:
        ...
        self.assertIn('"mobile.closeFilters": "Cerrar filtros y ajustes"', script)
        self.assertIn('"mobile.closeFilters": "Close filters and settings"', script)
        ...
        self.assertIn("function syncMobileMenuToggleState()", script)
        self.assertIn('i18n(expanded ? "mobile.closeFilters" : "mobile.openFilters")', script)
        self.assertIn("sidebarToggle.setAttribute(\"aria-label\"", script)
        ...
        self.assertNotIn("body.mobile-drawer-open .mobile-menu-toggle span", styles)
        self.assertIn("body.mobile-drawer-open .sidebar-toggle span", styles)
        self.assertIn("body.mobile-drawer-open .sidebar-toggle span::before", styles)
        self.assertIn("transform: rotate(45deg)", styles)
        self.assertIn("body.mobile-drawer-open .sidebar-toggle span::after", styles)
        self.assertIn("transform: rotate(-45deg)", styles)
        ...
        self.assertIn("width: min(360px, calc(100vw - 28px))", mobile_styles)
        self.assertIn("max-width: calc(100vw - 28px)", mobile_styles)
        self.assertIn(".feed-controls input[type=\"date\"]", mobile_styles)
        self.assertIn("font-size: 16px", mobile_styles)
        self.assertIn("min-height: 44px", mobile_styles)
        ...
        self.assertIn(".sidebar .account-section", mobile_styles)
        self.assertIn("display: none", mobile_styles.split(".sidebar .account-section", maxsplit=1)[1].split("}", maxsplit=1)[0])
